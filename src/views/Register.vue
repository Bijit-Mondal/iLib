<template>
<div>
    <h1 style="text-align:center" class="pure_cursive color">Create a New Account</h1>
    ...
    <vs-row justify="space-around">
       <vs-col :w="w" style="margin-bottom:20px;">
         <vs-input style="align-items:center" v-model="user_name" state="warn" warn class="color Inconsolata" placeholder="Enter Your Name  ">
           <template #icon>
       ...
       <vs-col :w="w" style="margin-bottom:30px;">
         <vs-input style="align-items:center" state="warn" v-model.number="mobile" type="tel" warn class="color Inconsolata" placeholder="Enter Mobile Number ">
           <template #icon>
    ...
    <vs-row justify="space-around">
       <vs-col :w="w" style="margin-bottom:20px;">
         <vs-input style="align-items:center" v-model="email" type="email" state="warn" warn class="color Inconsolata" placeholder="Enter Your EMail Id  ">
           <template #icon>
       ...
       <vs-col :w="w" style="margin-bottom:30px;">
         <vs-input style="align-items:center" state="warn" type="password" v-model="pin" warn class="color Inconsolata" placeholder="Enter your pin ">
           <template #icon>
    ...
    <vs-row justify="space-around">
        <vs-col :w="w" style="margin-bottom:20px;">
         <vs-input style="align-items:center" v-model="address" type="text" state="warn" warn class="color Inconsolata" placeholder="Address  ">
           <template #icon>
       ...
       <vs-col :w="w" style="margin-bottom:20px;">
        <vs-input style="align-items:center;" state="warn" warn class="color Inconsolata" label="Profile Image(less than 350KB)" @change='chooseFile()' type="file"></vs-input>
       </vs-col>
    ...
    <vs-row justify="space-around">
       ...
       <vs-col :w="w">
         <vs-button gradient warn class="pure_cursive btn_center" :active="active == 1" @click="create">
           Create 
        </vs-button>
       </vs-col>
