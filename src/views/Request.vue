<template>
  <div>
    <h1 style="text-align:center" class="pure_cursive color">Borrow a New Book</h1>
    ...
    <vs-row justify="space-around">
       <vs-col :w="w" style="margin-bottom:20px;">
         <vs-input style="align-items:center" v-model="query" state="warn" warn class="color Inconsolata" placeholder="Enter Book/Writer Name  ">
           <template #icon>
       ...
       <vs-col :w="w">
         <vs-button gradient warn class="pure_cursive btn_center" :loading="load" @click="search" :active="active == 1">
           Search
        </vs-button>
       </vs-col>
        ...
        <template #tbody>
          ...
          <template #expand>
              <vs-row justify="space-between">
                ...
                <vs-col w="3">
                  <vs-button v-if="book.nob>1" :active="active == 2"  class="pure_cursive" border @click="request(book.isbn)" upload success>
                    Request The Book
                  </vs-button>
                  <vs-button v-else class="pure_cursive" success @click="request(book.isbn)"  disabled>
                    Request The Book
                  </vs-button>
                </vs-col>
                ...
                <vs-col w="3" v-if="book.have_pdf">
                  <vs-button class="pure_cursive" @click="pdfDownload(book.isbn,book.book_name)" flat warn>
                    Download The Pdf
                  </vs-button>
                </vs-col>
...
export default {
  data() {
         return {
            w: 12,
            APP_ID: 'DPTWCX82V5',
            API_KEY:'3e2ef5c8a84ce24c9f7cd6ddc57aaf6e',
            books:[],
            windowWidth: 721,
            active:0,
            query:'',
