...
<template>
    <div class="hidden">
      <vs-navbar style="position:fixed;" center-collapsed v-model="active">
        ...
        <template #right>
          <vs-button class="Inconsolata" :color="btn_color" v-if="login==0"  :active="active_button == 1" @click="active_button = 1" flat to="/login">Login</vs-button>
          <vs-button class="Inconsolata" :color="btn_color" v-if="login==1"  :active="active_button == 3" @click="open_logout_modal" flat>LogOut</vs-button>
          <vs-button class="Inconsolata" :color="btn_color"  @click="active_button = 2"  to="/dashboard" gradient>Get Started</vs-button>
        </template>
      </vs-navbar>
      <vs-sidebar
        ...
        <vs-sidebar-item class="Inconsolata" id="home" to="/" :color="btn_color">
          <template #icon>
              <span class="material-icons-outlined ">home</span>
          </template>
          Home
        </vs-sidebar-item>
        <vs-sidebar-item class="Inconsolata" to="/dashboard" id="dashboard">
          <template #icon>
            <span class="material-icons-outlined">dashboard</span>
          </template>
          Dashboard
        </vs-sidebar-item>
        <vs-sidebar-item class="Inconsolata" to="/info" id="account">
          <template #icon>
            <span class="material-icons-outlined">account_box</span>
          </template>
          Account Details
        </vs-sidebar-item>
        <vs-sidebar-item class="Inconsolata" to="/request" id="request">
          <template #icon>
        ...
        <vs-sidebar-group>
          <template #header>
            <vs-sidebar-item class="Inconsolata" arrow>
              <template #icon>
          ...
          <vs-sidebar-item to='/studentdetails' class="Inconsolata" id="studentdetails">
            <template #icon>
              <span class="material-icons-outlined">settings_suggest</span>
            </template>
            Student's Details
          </vs-sidebar-item>
          <vs-sidebar-item to="/add" class="Inconsolata" id="books_add">
            <template #icon>
              <span class="material-icons-outlined">library_books</span>
            </template>
            Add Books
        ...
        <vs-sidebar-item href="https://github.com/Bijit-Mondal/ilib" class="Inconsolata" id="github">
          <template #icon>
        ...
        <vs-sidebar-item href="https://rkmvccrahara.org/" class="Inconsolata" id="college">
          <template #icon>
            <span class="material-icons-outlined">school</span>
          </template>
          College
        </vs-sidebar-item>
        <vs-sidebar-item href="https://bijit-mondal.github.io/Bijit-Mondal/" class="Inconsolata" id="other">
          <template #icon>
      ...
      <vs-dialog width="300px" not-center v-model="logout_modal">
       <template #header>
         <h3 style="text-align:center" class="Inconsolata not-margin">
           Welcome {{username}}
         </h3>
       </template>
       ...
       <div class="con-content">
         <h4 class="Inconsolata" style="text-align:center">Are you sure you want to logout</h4>
       </div>

       <template #footer>
         <div class="con-footer">
           <vs-button class="Inconsolata" @click="logout" transparent>
             Yes
           </vs-button>
           <vs-button class="Inconsolata" @click="logout_modal=!logout_modal" success transparent>
             Cancel
           </vs-button>
         </div>
       </template>
